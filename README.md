...
**English** · [中文](README_ZH.md) · [System Design](docs/SYSTEM_DESIGN.md) · [Evaluation](docs/RAG_EVAL_GUIDE.md) · [Operations](docs/OPERATIONS.md)
...
| **Output** | Answers with chunk citations and traces, plus optional Wiki, Markdown, PPTX, DOCX, BibTeX / LaTeX, and PDF deliverables |
...
Requirements: Python 3.10–3.12. The first BGE-M3 run downloads its model weights. An OpenAI-compatible endpoint is needed for generated answers; retrieval and most tests run without one.
